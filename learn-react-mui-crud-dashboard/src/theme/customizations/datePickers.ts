...
// export const datePickersCustomizations: PickersComponents<Theme> & PickerComponents<Theme> = {
//   MuiPickerPopper: {
//     styleOverrides: {
//       paper: ({ theme }) => ({
//         marginTop: 4,
...
// Date-picker customizations are stubbed out (see CLAUDE.md). This keeps the
// file a module under --isolatedModules until the contents above are restored.
export {};
